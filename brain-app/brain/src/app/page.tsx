...
export default function LandingPage() {
  return (
    <div className="overflow-hidden pt-4 bg-slate-200 dark:bg-slate-950">
      ...
      <div className="relative isolate px-6  lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-12">
          <div className="text-center">
            ...
            />
            <h1 className="dark:text-gray-50 text-2xl font-bold tracking-tight text-gray-900 sm:text-6xl">
